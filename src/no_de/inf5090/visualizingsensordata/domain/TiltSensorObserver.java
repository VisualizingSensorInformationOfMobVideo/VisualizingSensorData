...
/**
 * This class keeps track of the tilting of the camera
 * @author aage
 *
 */
public class TiltSensorObserver extends Observable implements Observer {
	 ...
	 */
	public TiltSensorObserver(SensorManager sensorManager) {
	...
	public void update(Observable observable, Object data) {
		...
		setChanged();
		try {
			notifyObservers(new SensorData(this, (float)(getPitch() / Math.PI), new Date()));
		} catch (Exception e) {
